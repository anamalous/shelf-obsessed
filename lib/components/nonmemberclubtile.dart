...
class NonMemberTile extends StatelessWidget {
  final bcid, name, uid;

  final String joinclub = '''mutation(\$u:Int!,\$b:Int!) {
                              joinClub(uid:\$u,bcid:\$b){
                                      s
                               }
                        }''';
